...
/**
 * Common exception type for exceptions which are propagated to users.
 * This exception type should only be used for exceptions which are
 * caused by user-interaction-based reasons, not technical reasons.
 */
