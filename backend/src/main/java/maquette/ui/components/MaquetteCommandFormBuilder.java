...
public class MaquetteCommandFormBuilder<RESULT extends CommandResult, CMD extends Command<RESULT>> {

    private final Class<CMD> commandType;

    private final Function0<CMD> getInitialCommand;

    private final MaquetteSpringCommandRunner commandRunner;

    private final Map<Field, Set<FormVariant>> variants;

    public MaquetteCommandFormBuilder(Class<CMD> commandType, MaquetteSpringCommandRunner commandRunner, Function0<CMD> getInitialCommand) {
        this(commandType, getInitialCommand, commandRunner, new HashMap<>());
    }

    public MaquetteCommandFormBuilder(Class<CMD> commandType, MaquetteSpringCommandRunner commandRunner) {
        this(commandType, () -> null, commandRunner, new HashMap<>());
    }

    public MaquetteCommandFormBuilder<RESULT, CMD> addVariant(Field field, FormVariant... variants) {
    ...
    public MaquetteCommandFormBuilder<RESULT, CMD> addVariant(String field, FormVariant... variants) {
    ...
    public MaquetteCommandForm<RESULT, CMD> build() {
        ...
        return new MaquetteCommandForm<>(
            binder,
