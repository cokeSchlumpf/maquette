...
import maquette.controller.domain.api.commands.views.ApprovedVM;
import maquette.controller.domain.api.commands.views.AuthorizationVM;
import maquette.controller.domain.api.commands.views.RevokedVM;
...
public class DatasetAccessRequestVM {
    ...
    public static DatasetAccessRequestVM apply(DatasetGrant request, DatasetDetails dsDetails, User executor, OutputFormat of) {
        return new DatasetAccessRequestVM(
            ...
            of.format(request.getRequest().map(AccessRequest::getJustification)),
