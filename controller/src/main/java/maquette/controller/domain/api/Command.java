...
import maquette.controller.domain.api.commands.AboutCmd;
import maquette.controller.domain.api.commands.datasets.ApproveDatasetAccessRequestCmd;
import maquette.controller.domain.api.commands.datasets.ChangeDatasetDescriptionCmd;
import maquette.controller.domain.api.commands.datasets.ChangeDatasetPrivacyCmd;
import maquette.controller.domain.api.commands.datasets.CreateDatasetConsumerToken;
import maquette.controller.domain.api.commands.datasets.CreateDatasetProducerToken;
import maquette.controller.domain.api.commands.datasets.DeleteDatasetCmd;
import maquette.controller.domain.api.commands.datasets.GrantDatasetAccessCmd;
import maquette.controller.domain.api.commands.datasets.ListDatasetVersionsCmd;
import maquette.controller.domain.api.commands.datasets.PrintDatasetDetailsCmd;
import maquette.controller.domain.api.commands.datasets.PrintDatasetVersionDetailsCmd;
import maquette.controller.domain.api.commands.datasets.RequestDatasetAccessCmd;
import maquette.controller.domain.api.commands.datasets.RevokeDatasetAccessCmd;
import maquette.controller.domain.api.commands.projects.ChangeProjectDescriptionCmd;
import maquette.controller.domain.api.commands.projects.ChangeProjectOwnerCmd;
import maquette.controller.domain.api.commands.projects.ChangeProjectPrivacyCmd;
import maquette.controller.domain.api.commands.projects.CreateProjectCmd;
import maquette.controller.domain.api.commands.projects.GrantProjectAccessCmd;
import maquette.controller.domain.api.commands.projects.ListProjectDatasetsCmd;
import maquette.controller.domain.api.commands.projects.PrintProjectDetailsCmd;
import maquette.controller.domain.api.commands.projects.RevokeProjectAccessCmd;
import maquette.controller.domain.api.commands.shop.FindDatasetsCmd;
import maquette.controller.domain.api.commands.shop.FindProjectsCmd;
import maquette.controller.domain.api.commands.shop.ListDatasetsCmd;
import maquette.controller.domain.api.commands.shop.ListProjectsCmd;
import maquette.controller.domain.api.commands.users.DeleteTokenCmd;
import maquette.controller.domain.api.commands.users.GetNotificationsCmd;
import maquette.controller.domain.api.commands.users.ListTokensCmd;
import maquette.controller.domain.api.commands.users.RegisterTokenCmd;
import maquette.controller.domain.api.commands.users.RenewTokenCmd;
