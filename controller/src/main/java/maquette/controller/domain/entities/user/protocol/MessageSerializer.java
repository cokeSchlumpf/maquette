...
public class MessageSerializer extends AbstractMessageSerializer {
    ...
    protected Map<String, Class<?>> getManifestToClass() {
        ...
        m.put("users/commands/create-dataset-access-request-link/v1", CreateDatasetAccessRequestLink.class);
        ...
        m.put("users/events/created-dataset-access-request-link/v1", CreatedDatasetAccessRequestLink.class);
