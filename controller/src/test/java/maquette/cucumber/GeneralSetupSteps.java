...
public class GeneralSetupSteps {
    ...
    public void we_have_the_following_additional_role_owned_namespaces(io.cucumber.datatable.DataTable dataTable) {
    ...
    public void namespace_contains_the_following_datasets(String string, io.cucumber.datatable.DataTable dataTable) {
        // Write code here that turns the phrase above into concrete actions
        // For automatic transformation, change DataTable to one of
        // E, List<E>, List<List<E>>, List<Map<K,V>>, Map<K,V> or
        // Map<K, List<V>>. E,K,V must be a String, Integer, Float,
    ...
    public void we_have_the_following_users(io.cucumber.datatable.DataTable dataTable) {
